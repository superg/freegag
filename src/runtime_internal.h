...
struct DesktopPresentationState
{
    ...
    PortableRectangle windowed_rectangle;
};
...
inline RuntimeGenericResourceLoadApi runtime_generic_resource_load_api{ allocate_runtime_heap };
inline RuntimeTreeParserContextApi runtime_tree_parser_context_api{ allocate_runtime_heap };
inline RuntimeTreeParserReleaseApi runtime_tree_parser_release_api{ free_runtime_heap, remove_runtime_generic_resource };
...
inline ScriptUtilityApi script_utility_api{ runtime_milliseconds, std::srand, std::rand };
...
inline RuntimeTreeAuxiliaryCreateApi runtime_tree_auxiliary_create_api{ allocate_runtime_heap, free_runtime_heap, resolve_runtime_tree_auxiliary };
...
inline RuntimeTreeCreationApi runtime_tree_creation_api{ find_runtime_tree_node_by_identity, find_runtime_generic_resource, find_runtime_tree_root_identity_by_name, find_runtime_tree_ancestor_root,
    find_runtime_tree_descendant_identity_by_name, find_script_section, find_script_property_value, begin_runtime_tree_enumeration, get_next_runtime_tree_node, allocate_runtime_heap,
    free_runtime_heap, find_or_create_runtime_tree_parser_context, remove_runtime_generic_resource, dispatch_runtime_tree_parser, activate_created_runtime_tree_node };
...
inline RuntimeTreeAuxiliaryReleaseApi runtime_tree_auxiliary_release_api{ notify_runtime_tree_auxiliary_release, free_runtime_heap };
...
inline RuntimeTreeDestructionCoreApi runtime_tree_destruction_core_api{ find_runtime_tree_node_by_identity, notify_runtime_tree_destruction, remove_runtime_tree_scene_link_range,
    ...
    remove_runtime_tree_link_008c_range, remove_script_object_container_range, free_runtime_heap, destroy_script_object_container, release_runtime_tree_auxiliary_nodes,
    release_runtime_tree_parser_contexts, find_existing_runtime_tree_parser_context, dispatch_runtime_tree_parser, update_runtime_tree_global_links };
inline ScriptObjectMemoryApi script_object_memory_api{ allocate_runtime_heap };
inline ScriptObjectReleaseApi script_object_release_api{ free_runtime_heap };
...
inline RuntimeNamedNodeMemoryApi runtime_named_node_memory_api{ allocate_runtime_heap, free_runtime_heap };
...
inline RuntimeScriptExecutorApi runtime_script_executor_api{ runtime_milliseconds, runtime_milliseconds, runtime_sleep, process_available_runtime_generic_children, process_runtime_message,
...
inline RuntimeBootstrapApi runtime_bootstrap_api{ create_display_surface, get_display_palette_entries, initialize_display_scene_host, acquire_display_scene_node, lock_display_scene_node,
    unlock_display_scene_node, acquire_display_lock, set_display_clip_rectangle, release_display_lock, operate_display_surface, reset_runtime_display_state };
inline RuntimeDisplayShutdownApi runtime_display_shutdown_api{ get_or_create_runtime_named_node, release_display_scene_node, shutdown_display_scene_host, teardown_display_palette_surface };
...
inline RuntimeImmediateSceneTransitionApi runtime_immediate_scene_transition_api{ acquire_display_lock, set_display_clip_rectangle, release_display_lock, acquire_runtime_lock_record,
    dispatch_display_scene_update, runtime_sleep, synchronize_display_region, apply_display_palette, release_runtime_lock_record };
...
inline RuntimePaletteSceneTransitionApi runtime_palette_scene_transition_api{ acquire_runtime_lock_record, apply_immediate_runtime_scene_transition, acquire_display_lock, apply_display_palette,
    operate_display_surface, set_display_clip_rectangle, dispatch_display_scene_update, release_display_lock, release_runtime_lock_record, runtime_milliseconds, runtime_sleep,
...
inline RuntimeRectangleSceneTransitionApi runtime_rectangle_scene_transition_api{ acquire_runtime_lock_record, apply_immediate_runtime_scene_transition, acquire_display_lock,
    ...
    runtime_milliseconds, runtime_sleep, release_runtime_lock_record };
...
inline RuntimeResourceSceneDestructionApi runtime_resource_scene_destruction_api{ acquire_runtime_lock_record, destroy_runtime_resource, release_runtime_lock_record, runtime_sleep,
...
inline RuntimeResourceSelectionApi runtime_resource_selection_api{ lock_runtime_mutex, close_cdf_archive, unlock_runtime_mutex, construct_runtime_resource };
...
inline RuntimeResourceWaitApi runtime_resource_wait_api{ runtime_sleep };
...
inline RuntimeResourceHostApi runtime_resource_host_api{ lock_runtime_mutex, unlock_runtime_mutex, destroy_async_file_host, create_async_file_host, set_async_file_host_mode, close_cdf_archive };
inline void *&runtime_resource_cache_parent_identity = runtime_display_context.resource_cache_parent_identity;
inline RuntimeResourceTypeApi runtime_resource_type_api{ lock_runtime_mutex, unlock_runtime_mutex, find_runtime_resource_cache_entry, update_runtime_resource_host, get_cdf_entry_flags };
inline RuntimeCdfStreamApi runtime_cdf_stream_api{ compare_ascii_case_insensitive };
inline ArchiveCommentEnumerationApi archive_comment_enumeration_api{ open_cdf_archive, get_cdf_error, get_cdf_entry_size, read_cdf_entry, close_cdf_archive };
...
inline RuntimeResourceLoadApi runtime_resource_load_api{ lock_runtime_mutex, unlock_runtime_mutex, find_runtime_resource_cache_entry, open_async_file_record, get_async_file_size,
    activate_default_comment_scene, allocate_runtime_heap, free_runtime_heap, read_async_file_record, deactivate_default_comment_scene, reset_runtime_byte_queue, reset_runtime_pair_queue,
    get_or_create_runtime_resource_cache_entry, get_cdf_entry_flags, get_cdf_entry_size, open_runtime_cdf_entry_stream, read_cdf_entry, set_script_runtime_flags, runtime_sleep };
inline RuntimeResourceReleaseApi runtime_resource_release_api{ lock_runtime_mutex, unlock_runtime_mutex, find_runtime_resource_cache_entry, find_runtime_named_child, free_runtime_heap,
    remove_runtime_named_child_by_identity, close_async_file_record, set_script_runtime_flags };
inline RuntimeMediaBackendApi runtime_media_backend_api{ runtime_thread_id, lock_runtime_mutex_forever, unlock_runtime_mutex, free_runtime_heap, runtime_sleep };
inline RuntimeHeap *runtime_media_backend_heap;
inline RuntimeMutex *runtime_media_backend_mutex;
inline RuntimeBitmapRegionRenderApi runtime_bitmap_region_render_api{ lock_runtime_mutex_forever, unlock_runtime_mutex, copy_runtime_bitmap_region };
...
inline RuntimeMediaBackendShutdownApi runtime_media_backend_shutdown_api{ acquire_first_runtime_media_backend, release_runtime_media_backend_lock, destroy_runtime_heap, shutdown_runtime_sound };
inline RuntimeBitmapBackendCreateApi runtime_bitmap_backend_create_api{ allocate_runtime_heap, lock_runtime_mutex_forever, unlock_runtime_mutex };
inline RuntimeAnimationBackendCreateApi runtime_animation_backend_create_api{ get_async_file_position, read_async_file_record, allocate_runtime_heap, set_async_file_position,
    lock_runtime_mutex_forever, unlock_runtime_mutex };
inline RuntimeMediaBackendConfigureApi runtime_media_backend_configure_api{ lock_runtime_mutex_forever, unlock_runtime_mutex };
inline RuntimeAnimationBackendConfigureApi runtime_animation_backend_configure_api{ lock_runtime_mutex_forever, unlock_runtime_mutex, allocate_runtime_heap };
...
inline RuntimeMediaBackendFinalizeApi runtime_media_backend_finalize_api{ lock_runtime_mutex_forever, unlock_runtime_mutex, convert_runtime_bitmap_to_surface };
...
inline RuntimeAnimationFrameAcquireApi runtime_animation_frame_acquire_api{ read_async_file_record, allocate_runtime_heap, reallocate_runtime_heap, fail_runtime_animation };
...
inline RuntimeAnimationCompletionApi runtime_animation_completion_api{ runtime_sleep, set_async_file_position };
inline RuntimeAnimationAudioApi runtime_animation_audio_api{ runtime_milliseconds, runtime_sleep, allocate_runtime_heap, reallocate_runtime_heap, destroy_runtime_sound_handle,
    queue_runtime_sound_data, stop_runtime_sound, start_runtime_sound, create_runtime_sound_handle, query_runtime_sound_status, set_runtime_sound_playback_marker, set_runtime_sound_schedule_marker };
inline RuntimeAnimationWorkerApi runtime_animation_worker_api{ runtime_milliseconds };
...
inline RuntimeResourceConstructionApi runtime_resource_construction_api{
    runtime_process_heap,
    allocate_runtime_heap,
    free_runtime_heap,
    lock_runtime_mutex,
    unlock_runtime_mutex,
...
inline RuntimeGenericBackendApi runtime_generic_backend_api{ lock_runtime_mutex_forever, unlock_runtime_mutex, runtime_sleep, runtime_process_heap, free_runtime_heap };
inline RuntimeGenericBackendCreateApi runtime_generic_backend_create_api{ runtime_process_heap, allocate_runtime_heap, free_runtime_heap, lock_runtime_mutex_forever, unlock_runtime_mutex };
inline RuntimeGenericChildCreateApi runtime_generic_child_create_api{ acquire_runtime_generic_backend, find_runtime_generic_text_entry, parse_runtime_generic_integer, runtime_process_heap,
    allocate_runtime_heap, lock_runtime_mutex_forever, unlock_runtime_mutex, build_runtime_generic_backend_child_state, clear_runtime_generic_backend_ready };
...
inline RuntimeGenericBackendShutdownApi runtime_generic_backend_shutdown_api{ lock_runtime_mutex_forever, unlock_runtime_mutex, destroy_runtime_generic_backend };
inline RuntimeBackendInitializationApi runtime_backend_initialization_api{ create_runtime_heap, initialize_runtime_sound, lock_runtime_mutex_forever, unlock_runtime_mutex };
inline RuntimeResourceDestroyApi runtime_resource_destroy_api{ acquire_runtime_lock_record, lock_runtime_mutex, unlock_runtime_mutex, find_runtime_generic_resource, remove_runtime_generic_resource,
    ...
    release_display_scene_node, remove_runtime_named_child_by_identity, runtime_process_heap, free_runtime_heap };
...
inline RuntimeNamedLockApi runtime_named_lock_api{ runtime_thread_id, lock_runtime_mutex, unlock_runtime_mutex, runtime_sleep };
...
inline GraphicsHostApi graphics_host_api{ initialize_runtime_media_backend, initialize_async_file_subsystem, initialize_runtime_generic_backend, create_runtime_heap, initialize_sdl_presenter,
    set_script_runtime_root_if_valid, get_or_create_runtime_named_node, set_runtime_named_node_enabled };
inline GraphicsHostShutdownApi graphics_host_shutdown_api{ shutdown_runtime_display, shutdown_runtime_generic_backend, shutdown_async_file_subsystem, shutdown_runtime_media_backend,
    shutdown_sdl_presenter, destroy_runtime_heap };
...
inline RuntimeGameLifecycleApi runtime_game_lifecycle_api{ lock_runtime_mutex, update_runtime_resource_host, activate_default_comment_scene, deactivate_default_comment_scene, reset_runtime_byte_queue,
    reset_runtime_pair_queue, leave_runtime_state_1000, unlock_runtime_mutex };
inline RuntimeGameIntegrationApi runtime_game_integration_api{ initialize_linked_xtet, xtet::dispatch_game_input, xtet::execute_game_command, xtet::shutdown_game };
inline RuntimeGameDllDispatchApi runtime_game_dll_dispatch_api{ runtime_milliseconds, runtime_sleep };
inline RuntimePointerPositionApi runtime_pointer_position_api{ runtime_thread_id, lock_runtime_mutex, find_runtime_named_child, unlock_runtime_mutex, runtime_sleep, offset_display_scene_node };
...
inline AsyncFileShutdownApi async_file_shutdown_api{ destroy_async_file_host, lock_runtime_mutex, unlock_runtime_mutex };
inline AsyncFileHost *async_file_hosts;
inline RuntimeMutex async_file_global_mutex;
inline AsyncFileLockApi async_file_lock_api{ lock_runtime_mutex, unlock_runtime_mutex, runtime_sleep };
inline AsyncFileHostApi async_file_host_api{ runtime_milliseconds };
...
inline ValidationApi validation_api{ load_preferences_for_validation, enable_borderless_fullscreen };
...
{
    lock_runtime_mutex(&runtime_display_context.pair_queue_mutex);
}

inline void leave_runtime_pair_queue_lock()
{
    unlock_runtime_mutex(&runtime_display_context.pair_queue_mutex);
}

inline void enter_runtime_message_queue_lock()
{
    lock_runtime_mutex(&runtime_display_context.message_queue_mutex);
}

inline void leave_runtime_message_queue_lock()
{
    unlock_runtime_mutex(&runtime_display_context.message_queue_mutex);
}
...
inline RuntimeCommandLoopApi runtime_command_loop_api{ pause_runtime_game_dll_discard_result, pause_all_runtime_animations, pause_runtime_sound_output_discard_result, process_runtime_message,
    runtime_sleep, resume_runtime_sound_output_discard_result, resume_all_runtime_animations, resume_runtime_game_dll_discard_result, reset_runtime_session };
...
inline RuntimeSessionResetApi runtime_session_reset_api{ stop_runtime_game_dll, get_runtime_tree_root, destroy_runtime_tree_resources, deactivate_runtime_tree_and_visuals, reset_runtime_display_state,
    ...
    runtime_milliseconds, runtime_sleep };
...
inline DisplayLockReleaseApi display_lock_release_api{ runtime_thread_id, set_runtime_event };
inline DisplayLockAcquireApi display_lock_acquire_api{ runtime_thread_id, wait_runtime_event, runtime_sleep, lock_runtime_mutex, unlock_runtime_mutex, reset_runtime_event };
inline DisplaySceneMemoryApi display_scene_memory_api{ runtime_process_heap, allocate_runtime_heap, free_runtime_heap };
inline DisplaySceneWorkerApi display_scene_worker_api{ runtime_milliseconds, runtime_sleep, acquire_display_lock, synchronize_display_scene_node, publish_display_scene_node,
    release_display_lock_mode_1000, release_display_lock };
...
inline ApplicationInitializationApi application_initialization_api{ copy_string, validate_startup_environment, initialize_graphics_host, initialize_runtime_graphics, update_application_window_layout,
    enable_runtime_subsystem, set_active_object_field_0824, detect_runtime_resource_type };
